            ...
            <div className="col-sm-11">
              <div className="social-icons contactinfo pull-right">
                <ul className="nav navbar-nav">
                  <li><a href="https://www.facebook.com/noam.dadon.7524/"><i className="fa fa-facebook"></i></a></li>
                  <li><a href="https://www.linkedin.com/in/noam-dadon-323140128/"><i className="fa fa-linkedin"></i></a></li>
                  <li><a href="mailto:noamoni9@gmail.com"><i className="fa fa-envelope"></i> noamoni9@gmail.com</a></li>
                </ul>
              </div>
            </div>
