 ...
 * is an abstract class the allows the to send and get data using the client service with REST API
 */
@RestController
...
public abstract class ClientController {
     ...
     * Client login method
     *
     * @param userDetails- the email and password of the client for login
